...
User.create!                    # => #<User id: 1>
# >>    (0.5ms)  CREATE TABLE "users_2015" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)
...
# >>   SQL (0.1ms)  INSERT INTO "ar_internal_metadata" ("key", "value", "created_at", "updated_at") VALUES (?, ?, ?, ?)  [["key", "environment"], ["value", "default_env"], ["created_at", 2017-02-15 13:34:47 UTC], ["updated_at", 2017-02-15 13:34:47 UTC]]
