* 一目で思い出すためのSQLアンチパターン覚え書き
   ...
   | [[https://github.com/akicho8/sql_anti_pattern#SQLインジェクション][SQLインジェクション]]            | where("id = #{params[:id]}") | where(id: params[:id])     |                           |
   ...
   | [[https://github.com/akicho8/sql_anti_pattern#xxx_typeにモデル名を入れるアレ][xxx_typeにモデル名を入れるアレ]] | 整合性が揺らぐ・柔軟性がない | 使わない                   | 便利な面も多い            |
...
** [[polymorphic_associations][xxx_typeにモデル名を入れるアレ]]
