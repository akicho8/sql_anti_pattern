...
# >>    (15.5ms)  CREATE TABLE `users` (`id` int AUTO_INCREMENT PRIMARY KEY) ENGINE=InnoDB
...
# >>    (0.3ms)  BEGIN
# >>   SQL (0.2ms)  INSERT INTO `ar_internal_metadata` (`key`, `value`, `created_at`, `updated_at`) VALUES ('environment', 'default_env', '2017-02-12 13:50:08', '2017-02-12 13:50:08')
# >>    (0.5ms)  COMMIT
# >>    (0.1ms)  BEGIN
# >>   SQL (0.5ms)  INSERT INTO `articles` (`user_id`) VALUES (0)
# >>    (0.5ms)  ROLLBACK
